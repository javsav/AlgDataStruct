...
int main() {
  ...
  newList.printList();
	...
	newList.printList();
  std::cout << newList.get(5);
  newList.deletePosition(5);
  newList.printList();
  std::cout << newList.search(10) << "\n";
  std::cout << newList.search(100) << "\n";
  std::cout << newList.search(2) << "\n";
  std::cout << newList.search(20) << "\n";
  std::cout << newList.size() << "\n";
  newList.printList();
  std::cout << newList.get(100) << " " << newList.get(6) << "\n";
  newList.deleteList();
  newList.printList();

  LinkedList list2(10, 3);
  list2.printList();
